...
const GallerySection: React.FC<GallerySectionProps> = ({ galleryItems, showAll = false, topColor = '#ffffff' }) => {
  ...
  return (
    <section className="w-full overflow-hidden flex flex-col">
      {/* Top Section + Wavy Image Graphic */}
      <div className="w-full flex flex-col relative z-20 -mb-[2px]">
        {/* Wavy Image Divider */}
        <img
          src="/rr.png"
          alt="Divider graphic"
      ...
      <div className="py-12 md:py-20 bg-[#483E9A] w-full">
        <div className="section-container w-full max-w-7xl mx-auto px-4 md:px-8">
          <h2 className="text-center text-3xl md:text-4xl lg:text-5xl text-primary-brown mb-10 md:mb-14 font-general-sans font-bold tracking-tight">
            Our Shop Gallery
          </h2>
