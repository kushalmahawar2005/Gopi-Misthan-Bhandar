    ...
    <section className="w-full flex flex-col bg-white overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row min-h-[500px]">
        ...
        <div className="w-full md:w-1/2 relative h-[400px] md:h-auto overflow-hidden">
          <Image
            src="https://images.unsplash.com/photo-159089415225-401ed6f9db8e?q=80&w=1974&auto=format&fit=crop"
      ...
      <div className="flex flex-col-reverse md:flex-row min-h-[500px]">
        ...
        <div className="w-full md:w-1/2 relative h-[400px] md:h-auto overflow-hidden">
          <Image
            src="https://images.unsplash.com/photo-166082927389-6cd097cdc6ec?q=80&w=2070&auto=format&fit=crop"
