  ...
  return (
    <div className="relative flex flex-col items-center group">
      ...
      >
            ...
            >
              <div className="flex items-center justify-end gap-3 md:gap-4">
                ...
                <button
                  ...
                  className="p-2 md:p-2.5 bg-white/20 hover:bg-white/30 rounded-full backdrop-blur-sm transition-colors"
        ...
        {item.overlayText && (
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent flex items-end z-10 pointer-events-none">
