...
const CategoryCard: React.FC<CategoryCardProps> = ({ category }) => {
  ...
  return (
    <div className="relative w-full aspect-[4/5] sm:aspect-[3/4] lg:aspect-[4/5] overflow-hidden group cursor-pointer shadow-md hover:shadow-xl transition-all duration-500 bg-gray-200 rounded-xl border border-gray-100">
