  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-primary-brown font-serif">Orders</h1>
              ...
              {orders.map((order) => (
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <select
                    ...
                    className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(order.status)} focus:outline-none focus:ring-2 focus:ring-primary-red`}
                  >
                    <option value="pending">Pending</option>
                    <option value="processing">Processing</option>
                    <option value="shipped">Shipped</option>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-gray-600 uppercase">{order.paymentMethod}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
