...
export default function NewCategory() {
  ...
  const [formData, setFormData] = useState({
    ...
    image: '',
    description: '',
    order: 0, // Will be auto-assigned by API
  });
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-primary-brown font-general-sans">New Category</h1>
        <button
          onClick={() => router.back()}
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">Leave empty to auto-assign next position. Lower numbers appear first. Position = Order number.</p>
        </div>
