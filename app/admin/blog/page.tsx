...
export default function BlogPage() {
  ...
  const updateOrder = async (id: string, direction: 'up' | 'down') => {
    ...
    const sortedItems = [...blogs].sort((a, b) => a.order - b.order);
    const currentIndex = sortedItems.findIndex((b) => b._id === id);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-primary-brown font-serif">Blog Posts</h1>
